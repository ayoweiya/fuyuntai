...
<div class="container-lg clear-padding">
    ...
    <img src="${basePath}/resources/img/fuyuntai_index_01.png" alt="" width="100%">
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img src="${basePath}/resources/img/fuyuntai_index_02-1.png" alt="" width="100%">
            </div>
            <div class="swiper-slide">
                <img src="${basePath}/resources/img/fuyuntai_index_02-2.png" alt="" width="100%">
            </div>
            <div class="swiper-slide">
                <img src="${basePath}/resources/img/fuyuntai_index_02-3.png" alt="" width="100%">

            </div>
            <div class="swiper-slide">
                <img src="${basePath}/resources/img/fuyuntai_index_02-4.png" alt="" width="100%">
            </div>
        </div>
        <div class="swiper-button-prev" style="color:#c9a02a;"></div>
        <div class="swiper-button-next" style="color:#c9a02a;"></div>
    </div>
    <img src="${basePath}/resources/img/fuyuntai_index_03.png" alt="" width="100%">
    <img src="${basePath}/resources/img/fuyuntai_index_04_title.png" alt="" width="100%">
    <div class="productPlan px-sm-5 px-4 bg-white" id="productPlan">
        <div class="planGroup">
            <form action="" class="row flex-column align-items-center">
                <div class="col pb-3">
                    ...
                    <label for="plan1" class="d-flex align-items-center outer_option">
                        ...
                        <div class="planImg">
                            <img src="${basePath}/resources/img/fuyuntai_index_04_btn_1.png" alt="" width="100%">
                        </div>
                    </label>
                </div>
                <div class="col pb-3">
                    ...
                    <label for="plan2" class="d-flex align-items-center outer_option">
                        ...
                        <i class="fas fa-check-circle text-warning fa-3x"></i>
                        <div class="planImg">
                            <img src="${basePath}/resources/img/fuyuntai_index_04_btn_2.png" alt="" width="100%">
                        </div>
                    </label>
                </div>
                <div class="col pb-3">
                    ...
                    <label for="plan3Toogle" class="d-flex align-items-center infoToggle">
                        ...
                        <i class="fas fa-check-circle text-warning fa-3x"></i>
                        <div class="planImg">
                            <img src="${basePath}/resources/img/fuyuntai_index_04_btn_3.png" alt="" width="100%">
                        </div>
                    </label>
                ...
                <div class="col pb-3">
                    ...
                    <label for="plan4Toogle" class="d-flex align-items-center infoToggle">
                        ...
                        <i class="fas fa-check-circle text-warning fa-3x"></i>
                        <div class="planImg">
                            <img src="${basePath}/resources/img/fuyuntai_index_04_btn_4.png" alt="" width="100%">
                        </div>
                    </label>
                    <div class="plan-info mt-3" style="display: none;">
                        <div class="form-group">
            ...
            <div class="wrap-btn btn-fixed">
                <a href="#productPlan">
                    <img src="${basePath}/resources/img/fuyuntai_index_btn_send_2.png" alt="" width="100%">
                </a>
            </div>
    ...
    <div class="position-relative">
        <img src="${basePath}/resources/img/fuyuntai_index_05.png" alt="" width="100%">
        <a href="${basePath}/orderList.html" class="checkOredr-btn">
            <img src="${basePath}/resources/img/fuyuntai_index_btn_order_2.png" alt="" width="100%">
        </a>
    </div>
    <div class="content-info d-flex flex-column align-items-center bg-white pb-5">
        <img src="${basePath}/resources/img/fuyuntai_index_06.png" alt="" width="100%">
